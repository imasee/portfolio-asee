...
const MONGODB_COLLECTION = process.env.MONGO_DB_COLLECTION_PERSONAL_INFO || "personalInfo";
const PERSONAL_INFO_ID = process.env.PERSONAL_INFO_ID || "pi_1";
...
exports.handler = async function (event, context) {
    if (event.httpMethod && event.httpMethod === "GET") {
        ...
        try {
            ...
            if (client) {
                let data = await getDataByID(client, PERSONAL_INFO_ID);
                return {
                    statusCode: 200,
                    headers: headers,
